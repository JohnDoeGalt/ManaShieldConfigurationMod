...
- BepInEx 5.x (Mono build) - Download from: https://github.com/BepInEx/BepInEx/releases
  Note: Use the "BepInEx_win_x64" Mono version, NOT IL2CPP
...
---------------
Q: Mod doesn't load
A: Make sure you're using BepInEx Mono (not IL2CPP). Check BepInEx/LogOutput.log
   for errors. The log should show "Mana Shield Revert" loading.

Q: Settings don't appear in menu
A: Make sure you're looking in Gameplay settings in the Main Menu, not after loading your game. Try
   restarting the game. Check the log for "settings injected" message.
...
CREDITS
-------
- Mod Author: JohnDoeGalt117 (Nexus Mods)
...
LICENSE
-------
This mod is provided as-is for personal use. Feel free to modify for your own
use. Please credit if redistributing.
